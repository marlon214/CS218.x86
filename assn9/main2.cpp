...
//	By default, C++ integers are doublewords (32-bits).
	...
	int	xList[MAXLENGTH]= {-1795,  -24,  49,  51,  53,  55,  57,  59,  61,  63,  
							65,  67 , 69,  71,  73,  75,  77,  79,  81,  83 , 
							85,  343,  725 };
	int yList[MAXLENGTH]={	-15840,  -2794 , -2136,  -2118 , -2116,  -1795 , -1787,  -1779,  -1771,  -1448 , 
							-1446,  -1438,  -1099  ,-1097,  -1034  ,-768,  -740,  -427,  -395,  -86 , 
								8 , 30,  41};
	int	len = 23;
	int	xMin=-1795;
	int	xMax=725; 
...
//  Loops to read numbers from user.
	...
	// 	if (readX)
	// 		cout << "Enter X Value (+/-septenary): ";
	// 	else
	// 		cout << "Enter Y Value (+/-septenary): ";
	// 	fflush(stdout);
